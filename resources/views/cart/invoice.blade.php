            ...
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <button data-action="print" class="flex-1 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:border-gray-400 transition flex items-center justify-center">
